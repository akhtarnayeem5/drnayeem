		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#trainingwiprohelloworldwipro-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"trainingwiprohelloworldwipro-display": {
								"semanticObject": "trainingwiprohelloworldwipro",
								"action": "display",
								"description": "Fiori application for Wipro training",
								"title": "Hello World Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=training.wipro.helloworldwipro",
									"url": sap.ui.require.toUrl("training/wipro/helloworldwipro")
								}
							}
						}
					}
